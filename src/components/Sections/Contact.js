    ...
    return (
        <div className="section mb-12" id='contact'>
            ...
            <section className='flex flex-col items-center'>
                ...
                <a className='flex border border-[--purple] border-2 rounded  text-xl mono px-10 py-5 mb-10 transition hover:bg-[--main-text-color] hover:text-[--purple] hover:border-[--main-text-color]' href={Icon[4].link}>Write to me</a>
